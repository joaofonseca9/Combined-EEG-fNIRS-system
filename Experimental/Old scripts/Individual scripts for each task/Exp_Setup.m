...
%Check automaticity results
while complete==0
    correct=input('Check the performance of the automaticity test. \n When ready to proceed, write CONTINUE', 's');
    if strcmpi(correct, 'CONTINUE')
        complete=1;
    else
        continue
    end
