...
frame_cross=round(0.1875*framerate)*ones(1,N_letters);
% frameduration= time_letter/framerate;
for n=1:N_letters
    %Defining number of frames per letter and cross
    time_letter= 0.75*rand(1);
    frame_letter(n)=round(time_letter+0.4125*framerate); %Speed with which the letters are presented
