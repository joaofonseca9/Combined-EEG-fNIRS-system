...
%     keypresses = convertKeypresses(keypresses);
    ...
    stim_file=moviePtr.auto.moviename(j);
    events_autodual.trial(j).stimuli=table(onset,duration, value, response, stim_file);
...
%     keypresses = convertKeypresses(keypresses);
            keypresses=convertKeypresses_DEV(keypresses);
            stim_file=moviePtr.nonauto.moviename(t);
            events_nonautodual.trial(t).stimuli=table(onset,duration, value, response, stim_file);
