...
outlet.push_sample(Marker_TestTest);
    ...
    DrawFormattedText(Window,Line1,.40*Xpixel,.3*Ypixel,[0 1 0]);
    DrawFormattedText(Window,Line2,.45*Xpixel,.3*Ypixel,white);
    DrawFormattedText(Window,Line3,.46*Xpixel,.3*Ypixel,[1 0 0]);
    DrawFormattedText(Window,Line4,.56*Xpixel,.3*Ypixel,white);
    Screen('TextSize',Window,50);
    DrawFormattedText(Window,Line5,'Center',.3*Ypixel,white);
    Screen('TextSize',Window,60);
    DrawFormattedText(Window,Line1,.45*Xpixel,.55*Ypixel,[0 1 0]);
    DrawFormattedText(Window,Line4,.50*Xpixel,.55*Ypixel,white);
    Screen('TextSize',Window,50);
    DrawFormattedText(Window,Line6,'Center',.55*Ypixel,white);
    DrawFormattedText(Window,Line7,'Center',.75*Ypixel,white);
    DrawFormattedText(Window,'>>',Xpixel*.9,Ypixel*.9,white);
    Screen('Flip', Window);
    GetClicks(Window);
...
%             [audiodata3Hz] = PsychPortAudio('GetAudioData',CAP_cue3Hz);
        ...
        case 4          % Go Only Task
            % Information Screen
            Screen('TextSize',Window,60);
            DrawFormattedText(Window,Line1,.45*Xpixel,.3*Ypixel,green);
            DrawFormattedText(Window,Line4,.49*Xpixel,.3*Ypixel,white);
