...
if data_loaded==0
    ...
    if strcmp(sub,'02') && strcmp(rec,'02')
        ...
        save(['sub-',sub,'_rec-',rec,'_nirs_events.mat'], 'eeg_fnirs_events');
    end
    ...
    if strcmp(sub,'02') && strcmp(rec,'02')
        ...
        load(['sub-',sub,'_rec-',rec,'_nirs.mat']);    %Avoids call to ft_preprocessing
        load(['sub-',sub,'_rec-',rec,'_nirs_events.mat']);%Avoids call to ft_readevents
    end
...
marker_table=checkMarkers(EEG,data_raw,eeg_fnirs_events);
