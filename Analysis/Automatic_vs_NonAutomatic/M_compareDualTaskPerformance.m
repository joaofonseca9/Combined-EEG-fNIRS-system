...
for subject = 1:size(subrec, 1)
    ...
    % Check if sequence typed was correct.
...
function checkIncorrectSequencePerTrial(dual, real_sequence)
    ...
    dual = events_dual.trial;
     ...
     for trial = 1:length(dual)
         ...
         if correctSequence == true & dual(trial).cue == 1
             dual_incorrectSequences
         
     end

end

% events_autodual.trial(h).responses.value
