function [h, xval_allconditions, yval_allconditions]=multiplot_condition_modified(data, layout, conditions, condition_names, varargin)
...
for con=1:length(conditions)
    ...
    for c=1:2:length(selchan)
        ...
        yval_allconditions(:, :, selchan(c), con) = yval;
        hold on;
