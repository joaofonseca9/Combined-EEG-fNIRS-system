...
channels = {'Rx1x-Tx2x', 'Rx1x-Tx3x', 'Rx2x-Tx3x', 'Rx2x-Tx4x', 'Rx3x-Tx2x', 'Rx3x-Tx3x', 'Rx3x-Tx5x', 'Rx4x-Tx4x', 'Rx4x-Tx5x', 'Rx5-Tx7', 'Rx5-Tx8', 'Rx7-Tx7', 'Rx7-Tx8', 'Rx6-Tx9', 'Rx8-Tx9', 'Rx8-Tx10', 'Rx1-Tx2', 'Rx1-Tx3', 'Rx3-Tx2', 'Rx3-Tx3', 'Rx2-Tx4', 'Rx4-Tx4', 'Rx4-Tx5', 'Rx1x-Tx1bx', 'Rx2x-Tx1ax', 'Rx3x-Tx1dx', 'Rx4x-Tx1cx', 'Rx5-Tx6b', 'Rx6-Tx6a', 'Rx7-Tx6d', 'Rx8-Tx6c', 'Rx1-Tx1a', 'Rx2-Tx1b', 'Rx3-Tx1c', 'Rx4-Tx1d'};
...
image = fullfile(mainpath_in, 'layout eeg-fnirs.png');
cfg = [];
cfg.image = image;
...
% Create mask: this area will be used when making a topoplot --> press q
% Create outline: these are the lines that will be shown in the layout
% (e.g. head shape, sulci) (see info on command window how to create 
% the polygon)--> press q
